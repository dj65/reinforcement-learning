.PHONY: install
PYTHON := python3.11 # Update to python or python3 or python3.11 etc
install:
	...
	# Installs pipenv to use to manage the virtual environment for which all dependencies will be installed based on Pipfile.lock. 
